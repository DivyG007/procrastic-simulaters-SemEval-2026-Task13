"""
train_graphcodebert.py — GraphCodeBERT Training Script
=======================================================
Self-contained script to fine-tune GraphCodeBERT (microsoft/graphcodebert-base)
...
This script:
  ...
  4. Trains DeepHeadModel(graphcodebert) with LLRD + cosine schedule + fp16
...
def main():
    """Full training + evaluation pipeline for GraphCodeBERT."""

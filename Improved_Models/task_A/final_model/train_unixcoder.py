"""
train_unixcoder.py — UniXcoder Training Script
================================================
Self-contained script to fine-tune UniXcoder (microsoft/unixcoder-base)
...
This script:
  ...
  4. Trains DeepHeadModel(unixcoder) with LLRD + cosine schedule + fp16
...
def main():
    """Full training + evaluation pipeline for UniXcoder."""
